...
## Téléchargement
Vous pouvez télécharger l'ISO directement depuis ce dépôt. Cliquez sur le fichier `debian-12.5.0-amd64-netinst.iso` puis sur le bouton de téléchargement.
...
## Avertissement
Le téléchargement et l'utilisation de l'ISO ne sont pas garantis par le site PassAndSecure. Le site et ses opérateurs ne sont pas responsables des problèmes ou des dommages qui pourraient survenir suite à l'utilisation de l'ISO. Nous fournissons cet ISO sans garantie d'aucune sorte ; utilisez-le à vos propres risques.
